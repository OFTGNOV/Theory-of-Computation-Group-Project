...
- Demonstrate mastery of **Theory of Computation concepts**, including:
  ...
  - Ambiguity analysis and its impact on parsing.  
  - Parser implementation (top-down or bottom-up).  
  - Grammar normalization (conversion to Chomsky Normal Form).  
- Show ability to:
  - Accept valid inputs and reject invalid ones.  
  - Generate parse trees or derivations.  
...
4. **Written Report**  
   ...
   - Parse trees/derivations for sample inputs.  
...
✅ In short: We are building a **custom parser and syntax checker** from scratch, proving our grasp of CFGs, parsing methods, and grammar transformations. The deliverables are both **technical (code, test cases)** and **theoretical (report, interview)**, with marks spread across design, implementation, and explanation.  
